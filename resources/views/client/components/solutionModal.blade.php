            ...
            @foreach($solutionProducts as $key=>$solutionProduct)
                @if($solution->id == $solutionProduct->solution_id)
                    <div class="img_point d-flex align-items-center justify-content-center" id="img_point{{$key}}" style="top: {{$solutionProduct->percent_y}}%; left: {{$solutionProduct->percent_x}}%">
                        <div class="img_point__body" style="{{$solutionProduct->percent_x < 50 ? 'left: 75px': 'left: -75px'}}">
                            <div class="img_point__body--info">
                                ...
                                <p class="img_point__body--code">Cod Produs: <span>{{$solutionProduct->product->code_1c}}</span>
                                </p>
                                <a href="" class="img_point__more_link">></a>
                            </div>
                            <div class="img_point__body--btn">
                                <a href="" style="color:#333232">{{$solutionProduct->product->price}} MDL</a>
                            </div>
                        </div>
                    </div>
                @endif
