        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2 align-items-start">
                ...
                <div class="col-sm-4 d-flex">
                    <a href="{{route('category.createCategory')}}" class="btn btn-outline-primary mr-5 px-3 ">
...
{{--                            <td> {{$item->sort_order}}</td>--}}
                            ...
                            <td class="d-flex">
                                ...
                                <div class="mr-2">
                                    <a href="{{route('category.editCategory', $item->id)}}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                </div>

                                <form action="{{route('category.deleteCategory', $item->id)}}" method="post" onsubmit="return confirm('{{trans('panel.accept_delete')}}');">
                                    @csrf
                                    @method(('delete'))
