...
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="mb-3">
                    <a href="{{route('category.edit', $industry->id)}}" class="btn btn-secondary" >
        ...
        <section class="content">
            <div class="container-fluid ml-4">
                <div class="form_container">
                    <form action="{{route('category.storeCategoryProducts')}}" method="post" class="w-100" enctype="multipart/form-data">
                        @csrf
