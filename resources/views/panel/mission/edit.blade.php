...
@section('content')
        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{$mission->name_ro}}</h1>
                    </div><!-- /.col -->
        ...
        <section class="content">
            <div class="container-fluid ml-4">
                <div class="form_container">
                    <form action="{{route('mission.update', $mission->id)}}" method="post" class="w-100" enctype="multipart/form-data">
                        @csrf
                        @method('patch')
                        <nav class="w-100">
                            ...
                            <div class="tab-pane fade show active" id="common" role="tabpanel" aria-labelledby="common-tab">
                                <div class="form_block row mb-3">
                                    ...
                                    <div class="form-group col-lg-2 col-sm-6">
                                        ...
                                        <input type="number" class="form-control" id="sort_order" name="sort_order" placeholder="Ordinea" value="{{$mission->sort_order}}">
                                ...
                                @include("panel.components.forms.title",["title" => "Numele misiunea", "placeholder" => "Numele misiunea", "valueRo" => $mission->title_ro, "valueRu" => $mission->title_ru, "valueEn" => $mission->title_en])
                                @include("panel.components.forms.description",["title" => "Descriere misiunea", "placeholder" => "Descriere misiunea", "valueRo" => $mission->description_ro, "valueRu" =>$mission->description_ru, "valueEn" => $mission->description_ro])
                                ...
                                <div class="form_block row mb-3 ">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-6 ml-3 d-flex flex-wrap" id="previewImageContainer">
                                            @if($mission->image)
                                                <a href="{{url('storage/'.$mission->image)}}" data-fancybox data-caption="Preview image">
                                                    <img id="image_preview" src="{{url('storage/'.$mission->image)}}" alt="Preview slider image" class="added_preview_image " onclick="" style="width: 300px">
                                                </a>
                                            @endif
                                        </div>
                                    </div>
