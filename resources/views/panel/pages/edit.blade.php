...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="mb-3">
                <a href="{{route('pages')}}" class="btn btn-secondary" >
    ...
    <section class="content">
        <div class="container-fluid ml-4">
            <div class="form_container">
                <form action="{{route('pages.update', $page->id)}}" method="post" class="w-100" enctype="multipart/form-data">
                    @csrf
                    @method('patch')

                    @include("panel.components.forms.title",["title" => $page->title_ro." title", "placeholder" => $page->title_ro. " title", "valueRo" => $page->title_ro, "valueRu" => $page->title_ru, "valueEn" => $page->title_en])
                    ...
                    @include("panel.components.forms.descriptionEditor2",["title" => "Descriere Cariere page", "placeholder" => "Descriere Cariere page", "valueRo" => $page->description_ro, "valueRu" => $page->description_ru, "valueEn" => $page->description_en])
