        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4 d-flex">
                    <a href="{{route('portfolio.createCategory')}}" class="btn btn-outline-primary mr-5 px-3 ">
...
{{--                            <td> {{$item->sort_order}}</td>--}}
                            ...
                            <td class="d-flex">
                                ...
                                <div class="mr-2">
                                    <a href="{{route('portfolio.editCategory', $item->id)}}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                </div>

                                <form action="{{route('portfolio.deleteCategory', $item->id)}}" method="post" onsubmit="return confirm('Вы действительно хотите удалить?');">
                                    @csrf
                                    @method(('delete'))
