    ...
    <!-- Main content -->
        ...
        <section class="content">
            <div class="container-fluid ml-4">
                <div class="form_container">
                    <form action="{{route('searchSettings.updateCategoryType', $searchSetting->id)}}" method="post" class="w-100" >
                        @csrf
                        @method('patch')
                            ...
                            <div class="form-group col-lg-3 col-sm-4 d-flex" data-select2-id="1">
                                <div>
                                    ...
                                    <select class="custom-select form-control" name="name" id="selectName" >
                                            ...
                                            <option value="category" {{$searchSetting->name == 'category'? 'selected': ''}} >Category</option>
                                            <option value="subcategory" {{$searchSetting->name == 'subcategory'? 'selected': ''}} >Subcategory</option>
                                    </select>
        ...
        @push('script')
            <script>
                ...
                if(searchSetting['name'] === 'category') {
                    categoryBlock.style.display = 'block'
                } else if(searchSetting['name'] === 'subcategory') {
