...
{{--                    </div>--}}
                ...
                <div class="col-md-3">
                    <a href="{{route('solution.categories')}}" class="btn btn-primary">Solution categorii</a>
                </div>
                    <div class="col-md-3">
                        <a href="{{route('mainPage')}}" class="btn btn-outline-success">Solutii la pagina principala</a>
                    </div>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 d-flex">
                    <a href="{{route('solution.create')}}" class="btn btn-outline-primary mr-5 px-3 ">
                ...
                <div class="col-12">
                    <table class="table table-hover text-nowrap" id="crudTable">
                        ...
                        <tr >
                            ...
                            <td class="d-flex">
{{--                                <div class="mr-2">--}}
{{--                                    <a href="{{route('solution.show', $item->id)}}" class="btn btn-sm btn-info">--}}
{{--                                        <i class="fas fa-eye"></i>--}}
{{--                                    </a>--}}
{{--                                </div>--}}
                                <div class="mr-2">
                                    <a href="{{route('solution.edit', $item->id)}}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                </div>

                                <form action="{{route('solution.delete', $item->id)}}" method="post" onsubmit="return confirm('Вы действительно хотите удалить?');">
                                    @csrf
                                    @method(('delete'))
