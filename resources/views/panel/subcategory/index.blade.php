        ...
        <div class="container-fluid">
            ...
            <form action="" method="GET" class="py-3">
                <div class="row">
                    ...
                    <div class="col-md-2 d-flex align-items-start">
                        ...
                        <a class="btn btn-outline-dark " href="{{url('/panel/subcategory')}}">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 d-flex">
                    <a href="{{route('subcategory.create')}}" class="btn btn-outline-primary mr-5 px-3 ">
...
{{--                            <th>Hurakan categories number</th>--}}
...
{{--                            <td> {{$item->hurakanCategoryNumber}}</td>--}}
                            <td> {{$item->productsNumber}}</td>

                            <td class="d-flex">
                                @if(isset($item->slug))
                                <div class="mr-2">
                                    <a href="{{route('subcategory.show', $item->id)}}" class="btn btn-sm btn-info">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                </div>
                                <div class="mr-2">
                                    <a href="{{route('subcategory.edit', $item->id)}}" class="btn btn-sm btn-warning">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                </div>

                                <form action="{{route('subcategory.delete', $item->id)}}" method="post" onsubmit="return confirm('{{trans('panel.accept_delete')}}');">
                                    @csrf
                                    @method(('delete'))
